...
-->
    ...
    <link rel="stylesheet" href="{{ URL::asset('css/bootstrap.min.css') }}">                                      <!-- Bootstrap style -->
    ...
    <link rel="stylesheet" href="{{ URL::asset('css/templatemo-style.css') }}">                                   <!-- Templatemo style -->
                            ...
                            <form action="index.html" method="get" class="tm-search-form tm-section-pad-2">
                                <div class="form-row tm-search-form-row">                                
                                    <div class="form-group tm-form-group tm-form-group-pad tm-form-group-1">
                                        ...
                                        <select name="destination"  class="form-control" id="inputCity" placeholder="Type your destination...">
                                            <option value="">Select Your destination</option>
                                            <option value="Paris, Italy">Paris, Italy</option>
                                            <option value="San Francisco, USA">San Francisco, USA</option>
                                            <option value="Lodon, UK">Lodon, UK</option>
                                            <option value="Lion, Singapore">Lion, Singapore</option>
                                            ...
                                            <option value="Las Vegas, England">Las Vegas, England</option>
                                        </select>
                                    </div>
    ...
    <!-- load JS files -->
    <script type="text/javascript" src="{{ URL::asset('js/jquery-1.11.3.min.js') }}"  ></script>             <!-- jQuery (https://jquery.com/download/) -->
    <script type="text/javascript" src="{{ URL::asset('js/popper.min.js') }}"   ></script>                    <!-- https://popper.js.org/ -->       
    <script type="text/javascript" src="{{ URL::asset('js/bootstrap.min.js') }}"   ></script>                 <!-- https://getbootstrap.com/ -->
    <script type="text/javascript" src="{{ URL::asset('js/datepicker.min.js') }}"   ></script>                <!-- https://github.com/qodesmith/datepicker -->
    <script type="text/javascript" src="{{ URL::asset('js/jquery.singlePageNav.min.js') }}"   ></script>      <!-- Single Page Nav (https://github.com/ChrisWojcik/single-page-nav) -->
    <script type="text/javascript" src="{{ URL::asset('slick/slick.min.js') }}"   ></script>                  <!-- http://kenwheeler.github.io/slick/ -->
    <script type="text/javascript" src="{{ URL::asset('js/jquery.scrollTo.min.js') }}"   ></script>           <!-- https://github.com/flesler/jquery.scrollTo -->
    <script> 
        /* Google Maps
        ------------------------------------------------*/
        var map = '';
