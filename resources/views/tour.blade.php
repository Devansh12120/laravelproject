...
<link rel="stylesheet" href="{{ URL::asset('css/plugins/font-awesome-4.7.0/css/font-awesome.min.css') }}"> 
<link rel="stylesheet" href="{{ URL::asset('css/plugins/OwlCarousel2-2.2.1/owl.carousel.css') }}"> 
<link rel="stylesheet" href="{{ URL::asset('css/plugins/OwlCarousel2-2.2.1/owl.theme.default.css') }}"> 
<link rel="stylesheet" href="{{ URL::asset('css/plugins/OwlCarousel2-2.2.1/animate.css') }}"> 
			...
			<div class="row fill_height">
				<div class="col fill_height">
					...
					<div class="search_panel">
						<form name="car" action="#" id="search_form_2" class="search_panel_content d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
							<div class="search_item">
								<div>State</div>
								<select type="text" class="destination search_input" name="destination">
									<option value="0">select destination</option>
