...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('css/popuo-box.css') }}">                                   
    <link rel="stylesheet" href="{{ URL::asset('css/styleerror.css') }}">
...
<body>
	...
	<div class="top-w3ls">
		<h2>404</h2>
		<h3> SORRY</h3>
		<p>It looks like that page no longer exist. Would you like to go to <a href="#">homepage</a>
		</p>
	...
	<div class="copyright">
		...
		<p>&copy; 2021  Error Page. All Rights Reserved | Design by <a href="#" target="_blank"> Travelville </a></p>
	</div>
